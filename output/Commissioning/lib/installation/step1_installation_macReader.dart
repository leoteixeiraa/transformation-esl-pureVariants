...
class Step1InstallationMacReader extends StatefulWidget {
  Step1InstallationMacReader({Key? key,
    this.customPaint,
    //this.onImage,
  ...
  @override
  State<StatefulWidget> createState() => _Step1InstallationMacReaderState();
}

class _Step1InstallationMacReaderState
    extends State<Step1InstallationMacReader> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Instalar etiqueta'),
      ),
      body: Padding(
