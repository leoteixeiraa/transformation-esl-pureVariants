...
class Step1SearchByMacMacReader extends StatefulWidget {
  Step1SearchByMacMacReader(
      {Key? key,
      this.customPaint,
      //this.onImage,
  ...
  @override
  State<StatefulWidget> createState() => _Step1SearchByMacMacReaderState();
}

class _Step1SearchByMacMacReaderState extends State<Step1SearchByMacMacReader> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:
            const Text("Consulta de etiqueta", style: TextStyle(fontSize: 24)),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: [
              Expanded(
                child: Image.asset(
                  'assets/esl/esl_mac_scan_indicator.png',
                  height: 250,
                  width: 250,
                ),
              ),
        ...
        if (value.isNotEmpty && mounted) {
          ...
          if (context.mounted && rtrn != null) {
            ...
            if (service.isMacValid(rtrn)) {
              Navigator.of(context).pushNamed(
                '/search/byMac/esl',
                arguments: SearchByMacArguments(
                  macAddress: rtrn,
                ),
              );
            } else {
          ...
          if (context.mounted) {
            /*Navigator.of(context).pushNamed(
              ...
              arguments: InstallationArguments(
                macAddress: value.first.rawValue,
              ),
            );*/
          }
        }
