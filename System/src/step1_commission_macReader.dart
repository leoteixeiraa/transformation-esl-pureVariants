...
class Step1CommissionMacReader extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _Step1CommissionMacReaderState();
}

class _Step1CommissionMacReaderState extends State<Step1CommissionMacReader> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title:
            const Text("Comissionar produto", style: TextStyle(fontSize: 24)),
      ),
      body: Padding(
          ...
          if (context.mounted && rtrn != null) {
            ...
            if (service.isMacValid(rtrn)) {
              Navigator.of(context).pushNamed(
                '/commissioning/commission/eanReader',
                arguments: CommissioningArguments(macAddress: rtrn),
              );
            } else {
